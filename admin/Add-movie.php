...
<div class="modal fade" id="edit_movie_modal_<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<script>
  $(document).ready(function(){
    // Xử lý sự kiện khi nhấp vào nút "Edit Movie"
    $('.edit_movie_modal_btn').click(function(){
      var movie_id = $(this).data('movie-id'); // Lấy id của phim
      var modal_id = '#edit_movie_modal_' + movie_id; // Tạo id của modal cần hiển thị
      $(modal_id).modal('show'); // Hiển thị modal để chỉnh sửa thông tin phim
    });
  });
</script>
<!-- <script>
  $(document).ready(function(){
    // Hiển thị modal "Add Movie" khi nhấp vào nút "Add Movie"
    $('#add_movie_modal_btn').click(function(){
      $('#add_movie_modal').modal('show');
    });

    // Hiển thị modal "Edit Movie" tương ứng khi nhấp vào nút "Edit Movie" của từng phim
    $('.edit_movie_modal_btn').click(function(){
